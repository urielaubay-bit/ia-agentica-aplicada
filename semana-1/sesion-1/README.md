...
## Pasos
- `npx tsx paso1.ts` — una generación simple (el LLM puede fallar la aritmética).
- `paso2.ts` — una tool tipada con Zod (se usa desde paso3).
- `npx tsx paso3.ts` — el loop agéntico: el modelo usa la tool. Espera `Pasos: >= 2` y el resultado correcto (5446 / 6446).
